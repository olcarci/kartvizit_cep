...
**İletişim e-postası:** olcarciyuz@hotmail.com

**İçerik derecelendirmesi (questionnaire):** Şiddet/cinsellik/kumar vb. hiçbiri yok → "Everyone / Herkes" bekleniyor.

**Veri Güvenliği (Data Safety) formu:**
- Bu uygulama veri topluyor mu? → **Hayır** (hiçbir veri cihaz dışına gönderilmiyor)
...
3. **Branch**: `main`, klasör: `/docs` seç, Save de
4. Birkaç dakika içinde sayfa şu adreste yayına girer: `https://olcarci.github.io/kartvizit_cep/privacy.html`
